  ...
  return (
    <div>
      ...
      <button 
        ...
        className={`bg-red-500 hover:bg-red-700 text-white font-bold py-[1%] px-[0%] rounded transition duration-300 ease-in-out ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
        disabled={loading}  
      >
