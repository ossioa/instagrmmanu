...
import { usePosts } from '../../contexts/PostsContext'; // Import usePosts
...
const CreatePost = () => {
  ...
  const { addPost } = usePosts(); // Use the addPost method from context
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      newPost.id = docRef.id; // Ensure to capture the new document ID from Firestore
      addPost(newPost); // Add the new post to the global state
