...
const CreatePost = () => {
  ...
  }, [file, caption, currentUser, navigate]); // Les dépendances utilisées dans la fonction
  ...
  useEffect(() => {
    ...
    if (data && currentUser) {
      ...
      handleSubmit(null); // Exécuter handleSubmit directement sans événement
    }
  }, [currentUser, handleSubmit]); // Ajouter handleSubmit comme dépendance pour répondre à l'avertissement ESLint
