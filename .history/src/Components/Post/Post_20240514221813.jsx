        ...
        <div className="border rounded-lg p-4 shadow-lg mb-4 bg-gray-100">
            ...
            <div className="py-2">
                ...
                <div className=" flex justify-end">
                    <button onClick={() => setShowComments(true)} className="text-blue-500 cursor-pointer border-spacing-2 font-bold fl"><FaComments className="inline-block"/>View Comments</button>
