...
const CreatePost = () => {
  ...
  }, [file, caption, currentUser, navigate]);
  ...
  useEffect(() => {
    ...
    if (data && currentUser) {
      ...
      handleSubmit(null); // Trigger handleSubmit directly without an event
    }
  }, [currentUser, handleSubmit]); // Include handleSubmit to the dependencies
