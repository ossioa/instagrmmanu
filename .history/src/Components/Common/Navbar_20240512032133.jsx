  ...
  return (
    <div className='flex justify-between items-center px-12 py-2 bg-gray-100 sticky top-0 z-20 shadow'>
      ...
      <div className='flex items-center justify-between gap-x-3'>
        ...
        <button className='text-white bg-violet-900 hover:bg-yellow-500 transform transition duration-500 ease-in-out hover:scale-110 font-bold px-2 py-0 shadow rounded text-[18px]'><Link to=<CreatePost/></button>
      </div>
        <SignOut/>
    </div>
  );
