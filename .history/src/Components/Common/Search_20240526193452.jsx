...
const Search = ({ onSearch }) => {
  ...
  return (
    <form onSubmit={handleSearch} className="flex items-center justify-center relative w-full">
      <input
        className="border-2 border-cyan-200 bg-white h-10 px-5 pr-10 rounded-lg text-sm focus:outline-none w-full"
        type="search"
        name="search"
        placeholder="Search"
        value={searchInput}
