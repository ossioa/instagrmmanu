...
import PostList from '../Post/PostList'; // Import du composant PostList
...
const Navbar = () => {
  ...
  const handleSearch = (searchValue) => {
    setSearchTerm(searchValue); // Met à jour la valeur de recherche
  };
  ...
  return (
    <>
      ...
      <PostList searchTerm={searchTerm} /> {/* Passer la valeur de recherche à PostList */}
    </>
  );
}
