...
const Navbar = () => {
  ...
  const [posts, setPosts] = useState([]); // Assuming you have posts state defined somewhere
  
  // Mock posts data for demonstration purpose
  const mockPosts = [
    { id: 1, caption: "First post" },
    { id: 2, caption: "Second post" },
    { id: 3, caption: "Third post" },
  ];
  
  //useEffect(() => {
  //   // Fetch posts data from database or any source
  //   setPosts(mockPosts);
