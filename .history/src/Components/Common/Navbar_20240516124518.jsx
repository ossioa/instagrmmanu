      ...
      <nav className={`flex justify-between items-center px-[2%] py-[1%] bg-gray-100 sticky top-0 z-20 shadow sm:px-8 md:px-12 ${isOpen ? 'hidden md:flex' : 'flex'}`}>
        ...
        <div className='flex justify-between gap-x-[2%] items-center'>
          ...
          <button
            ...
            className='bg-purple-600 hover:bg-purple-700 text-white text- font-bold py-[1%] px-[2%] rounded transition duration-300 ease-in-out flex flex-col items-center gap-y-2'
          >
            Create Post
          </button>
          <SignOut/>
