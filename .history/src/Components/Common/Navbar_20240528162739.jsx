  ...
  return (
    <>
      <nav className={`flex justify-between gap-2 items-center px-4 py-2 bg-gray-100 sticky top-0 z-20 shadow sm:px-8 md:px-12 ${isOpen ? 'hidden md:flex' : 'flex'}`}>
        <div className=' items-center space-x-4 sm:space-x-8 md:space-x-12'>
          <img src='https://toppng.com/uploads/preview/instagram-icon-logo-social-media-icon-png-and-vector-ico-115630611667i1r9uaklh.png' alt='logo' className='w-12 ml' />
          <span className=' font-extrabold text-blue-800 '>INSTAGRAM 241</span>
        </div>
