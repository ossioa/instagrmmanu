...
const Home = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-r from-green-400 via-yellow-500 to-blue-500 animate-gradient-x'>
      ...
      <main className="relative mx-auto sm:w-full md:w-[70%] lg:w-[55%] p-5 flex gap-5">
        <div className="flex-1">
          {renderContent()}
        </div>
        <div className="fixed right-0 top-20 flex justify-be gap-5 font-bold text-green-600">
