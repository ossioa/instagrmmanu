...
const Home = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-r from-green-400 via-yellow-500 to-blue-500 animate-gradient-x'>
      ...
      <main className="relative mx-auto sm:w-full md:w-[60%] lg:w-[45%] p-5 flex gap-5">
        <div className="flex-1">
          {renderContent()}
        </div>
        <div className="fixed right-0 top-20 flex justify-bween items-center gap-5 font-bold text-green-600 mr-10 ml">
